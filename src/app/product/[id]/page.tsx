    ...
    <div className="container animate-fade-in" style={{ paddingBottom: '4rem' }}>
      ...
      <div className="glass-panel" style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
          ...
          <div style={{ marginTop: 'auto', paddingTop: '2rem', borderTop: '1px solid var(--border-light)', display: 'flex', gap: '1rem' }}>
            {product.stock > 0 ? (
              <>
                <Link
                  href={`/checkout?productId=${product.id}`}
                  className="btn btn-primary"
                  style={{ flex: 1, padding: '1rem', fontSize: '1.1rem', textAlign: 'center', display: 'block' }}
                >
                  Buy Now
                </Link>
                <AddToCartButton
